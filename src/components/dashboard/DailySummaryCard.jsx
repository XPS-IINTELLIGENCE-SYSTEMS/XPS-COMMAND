      ...
      <div className="relative bg-card border border-border rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border sticky top-0 bg-card z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold metallic-gold">Daily Summary</h3>
          ...
          <div className="p-5 space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {Object.entries(summary.stageBreakdown).map(([stage, count]) => (
                    <div key={stage} className="glass-card rounded-lg px-3 py-1.5 text-[10px]">
            ...
            <div>
              ...
              {summary.automationResults.length === 0 ? (
                <div className="glass-card rounded-xl p-3 text-xs text-muted-foreground">No automation runs today yet</div>
              ) : (
            ...
            {summary.healthRecommendations && (
              <div>
                ...
                <div className="glass-card rounded-xl p-3 text-[10px] text-muted-foreground leading-relaxed whitespace-pre-wrap">
                  {summary.healthRecommendations}
                </div>
              </div>
            )}
