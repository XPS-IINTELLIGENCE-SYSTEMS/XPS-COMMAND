      ...
      <div className="p-4 md:p-6 space-y-6">
        <div className="text-center pt-2 pb-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/5 mb-4">
            ...
            <span className="text-xs font-semibold text-foreground">EXECUTE · JOBS</span>
          </div>
          <h1 className="text-2xl md:text-3xl font-extrabold xps-gold-slow-shimmer" style={{ fontFamily: "'Montserrat', sans-serif" }}>EXECUTE</h1>
          <p className="mt-2 text-xs text-muted-foreground">Scheduling, crews, tracking, and job completion</p>
        </div>
