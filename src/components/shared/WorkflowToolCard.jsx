...
export default function WorkflowToolCard({ num, label, Icon, description, statusBadge }) {
  return (
    <div className="shimmer-card group relative rounded-2xl border border-white/10 bg-card/40 backdrop-blur-xl overflow-hidden transition-all duration-300 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(212,175,55,0.08)]">
