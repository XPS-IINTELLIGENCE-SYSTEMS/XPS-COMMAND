...
import WorkOrderCard from "@/components/fieldtech/WorkOrderCard";
import JobDetailView from "@/components/fieldtech/JobDetailView";
      ...
      <div className="min-h-screen bg-background safe-top safe-bottom">
        <div className="max-w-lg mx-auto p-4">
          <JobDetailView
            ...
            onUpdated={() => {
              loadJobs();
              // Update the selected job in-place
