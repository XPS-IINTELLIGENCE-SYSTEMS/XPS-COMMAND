...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero */}
      <div className="flex flex-col items-center text-center px-6 pt-20 md:pt-32 pb-16">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl leading-none max-w-4xl" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
          <span className="xps-silver-gold-shimmer tracking-wide">XPS INTELLIGENCE</span>
        </h1>
