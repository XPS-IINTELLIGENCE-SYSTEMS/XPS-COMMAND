    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="flex items-center justify-between px-6 md:px-12 py-4 border-b border-border/50">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-foreground">
          ...
          <span className="hover:text-foreground cursor-pointer transition-all duration-300 hover:scale-110">Coverage</span>
          <span className="hover:text-foreground cursor-pointer transition-all duration-300 hover:scale-110">About</span>
        </div>
